...
<Incrementor title="Download our docker-compose.yml example file" />
...
<Incrementor productName={props.productName} title="Configure environment variables in docker-compose-{productName}.yaml file to customize your instance." />
