import WarningGpgKeyGeneration from '/docs/admin/_includes/warning/_gpg-key-generation.mdx'
...
<a className={"clean-btn"} href={"https://letsencrypt.org/"}>Let's Encrypt</a>
:::
...
- [Auto (Using Let's Encrypt)](https://help.passbolt.com/configure/https/ce/debian/auto.html)
- [Manual (Using user-provided SSL certificates)](https://help.passbolt.com/configure/https/ce/debian/manual.html)
...
:::caution
If you are running Passbolt 3.8.0 or higher version, you are able to configure your email server through the UI, any changes made will override the *config/passbolt.php*
...
- [Why are my emails not being sent?](https://help.passbolt.com/faq/hosting/why-email-not-sent)
- [How to generate JWT key pair manually](https://help.passbolt.com/faq/hosting/how-to-generate-jwt-key-pair-manually)
- [Troubleshoot SSL](https://help.passbolt.com/faq/hosting/troubleshoot-ssl)
- [How to rotate server GPG keys](https://help.passbolt.com/faq/hosting/how-to-rotate-server-gpg-keys)
