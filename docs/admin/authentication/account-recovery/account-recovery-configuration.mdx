...
Based on what best suits your organisation's preferences, you will enable it by choosing among the proposed policies by going to &#9881; *> Organisation settings > Account recovery*.
...
documentation: [how to generate an OpenPGP key](/hosting/openpgp/generate-keys/).
:::
...
section [enable the account recovery policy](#enable-the-account-recovery-policy).
