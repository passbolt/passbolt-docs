---
title: Configure Passbolt to Use Duo
sidebar_label: Duo
...
If you are [using docker](/hosting/install/ce/docker/), you can set these environment variables to enable Duo for your organisation.
...
To setup Duo as multi-factor authentication method, please refer to our [dedicated user guide](/user/advanced-features/mfa/duo/).
