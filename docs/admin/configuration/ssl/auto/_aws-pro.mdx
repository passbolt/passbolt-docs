...
<Figure src='https://help.passbolt.com/assets/img/help/2020/05/debian-package/configure_nginx_pro.png' alt='Configure nginx dialog' caption='fig. Configure nginx dialog' />
...
<Figure src='https://help.passbolt.com/assets/img/help/2020/05/debian-package/nginx_choices_pro.png' alt='nginx SSL dialog' caption='fig. nginx SSL dialog' />

You will now need to introduce the name of the domain name assinged to your server:

<Figure src='https://help.passbolt.com/assets/img/help/2020/05/debian-package/nginx_domain_pro.png' alt='nginx domain name' caption='fig. nginx domain name' />

Finally you will need to provide an email address for Let's encrypt to notify you for renewals and other admin info:

<Figure src='https://help.passbolt.com/assets/img/help/2020/05/debian-package/lets_encrypt_email_pro.png' alt='lets encrypt admin email' caption='fig. lets encrypt admin email' />

If everything goes fine you should see a final message that points you to finish passbolt configuration:

<Figure src='https://help.passbolt.com/assets/img/help/2020/05/debian-package/success.png' alt='Success message' caption='fig. Success message' />
