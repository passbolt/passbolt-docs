---
title: Generate OpenPGP Key with GnuPG
description: How to Generate an OpenPGP Key using GnuPG
---

# How to Generate an OpenPGP Key using GnuPG
...
:::warning
  <h4>Do you need to set a passphrase or not?</h4>
  Whether or not you need to set a passphrase will depend on why you are making this keypair.<br />
  <strong>1. Organization Account Recovery:</strong> In this case you want to set a passphrase. <br />
  <strong>2. Server GPG keys:</strong> In this case you do not want to set a passphrase. <br />
:::
