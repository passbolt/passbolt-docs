...
#### Force TLS (SSL)
We recommend using TLS (SSL) with Passbolt, this checks verify if passbolt has been configured to force TLS (SSL). If you have this error, you will need to set `passbolt.ssl.force` to true in */etc/passbolt/passbolt.php*
