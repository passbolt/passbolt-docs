...
:::info
Both options below are configurable in the Pro Edition, Business Cloud, Sovereign Cloud and Enterprise Cloud. In the Community Edition they are forced to true and cannot be disabled individually. Disabling password expiry as a whole, with the `PASSBOLT_PLUGINS_PASSWORD_EXPIRY_ENABLED` environment variable, is the only alternative.
:::
