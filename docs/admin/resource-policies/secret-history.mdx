...
Enables or disables the feature for the organisation. The plugin is loaded by default, but the feature stays off: no past versions are kept or shown until an administrator saves the settings.
