...
- See [Metadata Key](/docs/admin/resource-types/metadata-key) for key distribution configuration
...
- **Metadata**: resource names, URLs, and other metadata. Protection depends on the key configuration:
  - **Personal Key**: encrypted with the user's own OpenPGP key. See [Metadata Key](/docs/admin/resource-types/metadata-key).
  - **Shared Key (Zero-knowledge)**: encrypted with the shared metadata key, distributed manually by an administrator. See [Zero-Knowledge Mode](/docs/admin/resource-types/metadata-key#zero-knowledge-mode).
  - **Shared Key (Server-knowledge)**: encrypted with the shared metadata key, distributed automatically by the server. See [User-Friendly Mode](/docs/admin/resource-types/metadata-key#user-friendly-mode-default).
...
2. Configure key distribution in [Metadata Key](/docs/admin/resource-types/metadata-key)
