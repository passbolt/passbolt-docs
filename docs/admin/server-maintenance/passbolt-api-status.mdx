...
If the check fails, it means that NTP could be inactive, and your system clock may not be synchronized. You can take a look at our [dedicated documentation](/hosting/configure/ntp/) for that.
### Config Files
:::tip[PRO TIP]
