...
Then, to import the subscription key to the database since it prevent on file checking, you need to run:

<CodeBlock>
{`sudo su -s /bin/bash -c "/usr/share/php/passbolt/bin/cake passbolt subscripton_import" www-data`}
</CodeBlock>
