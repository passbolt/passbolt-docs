...
If your SSL certificate has been obtained through a public and well known SSL certificate authority such as [Let's encrypt](https://letsencrypt.org/) your certificate would be automatically trusted by the passbolt instance unless otherwise specified by your SSL provider.
...
<Figure
  src="https://help.passbolt.com/assets/img/help/2020/01/AD_ldaps_ssl_certificate_error.png"
...
OpenLDAP requires usually the entire chained certificate. We have developed a quick utility that aims to help retrieve all the parts of a LDAPS certificate and bundle them together. You can access this tool [here](https://github.com/passbolt/ldaps_cert_util).
...
:::warning
Do this for tests purpose only. This practice is insecure and could make your server prone to MITM attacks.
:::
