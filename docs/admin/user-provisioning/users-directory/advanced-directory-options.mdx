...
See: [Configure LDAP with TLS (SSL)](/docs/hosting/ldap/ldaps)
...
For detailed setup instructions, please refer to the [LDAPS page](/docs/hosting/ldap/ldaps/#step-3-download-a-certificate-chain).
