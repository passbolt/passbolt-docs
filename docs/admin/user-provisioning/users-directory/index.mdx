...
:::caution[Please note]
This guide explains how to configure the Ldap connector through the UI. For complex configurations (for example
custom field mapping in openldap) you will need to [configure ldap directly through the configuration file](https://help.passbolt.com/configure/ldap/ldap-from-configuration-file).
:::
...
See the how to in the [hosting guide](/hosting/configure/ldap/ldap-cron).
