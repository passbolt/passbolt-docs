---
title: Synchronize Users and Groups from Directory
...
If you want to automate the synchronization, you (or the person in charge of hosting) will need to [setup a cron job](/docs/hosting/ldap/ldap-cron/).

### Configure LDAPS (implicit TLS)

If your configuration doesn't run out of the box with LDAPS, you can refer to the [LDAP with TLS (SSL) configuration](/docs/hosting/ldap/ldaps/)
