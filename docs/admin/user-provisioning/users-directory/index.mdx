---
title: Configure User Directory
sidebar_label: User Directory
description: Configure User Directory
...
<Figure
  src="https://help.passbolt.com/assets/img/help/2018/09/AD_ldap_overview.png"
...
:::caution[Important]
If you have installed [Passbolt Pro](https://www.passbolt.com/pricing/pro) using our debian and ubuntu packages you can skip this section.
:::

The directory synchronization tools requires the [php-ldap extension](https://secure.php.net/manual/en/book.ldap.php) to be present on the server. If you built your own server the way you install php-ldap will depend on your system flavor.
...
For testing purpose, it might be handy to have some [ldap utilities](https://wiki.debian.org/LDAP/LDAPUtils) installed on your system. On Debian you can use ldapsearch for example to search for and display entries:
...
:::caution[Please note]
This guide explains how to configure the Ldap connector through the UI. For complex configurations (for example custom field mapping in openldap) you will need to [configure ldap directly through the configuration file](https://help.passbolt.com/configure/ldap/ldap-from-configuration-file).
:::
...
<Figure
  src="https://help.passbolt.com/assets/img/help/2018/12/AD_directory_sync_settings_disabled.png"
...
<Figure
  src="https://help.passbolt.com/assets/img/help/2018/12/AD_directory_sync_settings_enabled.png"
...
<Figure
  src="https://help.passbolt.com/assets/img/help/2018/12/AD_directory_sync_settings_saved.png"
...
<Figure
  src="https://help.passbolt.com/assets/img/help/2018/12/AD_directory_sync_simulation.png"
...
If your configuration doesn't run out of the box with LDAPS, you can refer to the [LDAP with SSL](/admin/user-provisioning/configure/ldap/ldap-with-ssl) documentation in order to adjust your config or throubleshoot your issue.
