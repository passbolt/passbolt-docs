...
1. Review our [Security Policy](https://www.passbolt.com/security)
2. Learn how to [Report a Vulnerability](/docs/contribute/security/vulnerability)
...
- [Passbolt API Documentation](/docs/api)
- [Community Forum](https://community.passbolt.com)
- [Installation Guide](/docs/hosting/install/) 