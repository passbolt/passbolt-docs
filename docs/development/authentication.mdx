...
After login and if MFA is required, or when the current MFA authorisation session expires, the current request will be redirected using the HTTP 403 FORBIDDEN code.
