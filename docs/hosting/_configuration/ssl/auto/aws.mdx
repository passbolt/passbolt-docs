...
By default, our nginx configuration file ensure all domain names will match with our passbolt virtual appliance but to obtain a valid Let's Encrypt TLS (SSL) certificate, you will have to manually set your passbolt domain name.
