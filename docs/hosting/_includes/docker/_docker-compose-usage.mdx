...
<div>
  <>
    <ul>
      ...
      <li>
        <a
          href={`https://help.passbolt.com/configure/https/${props.productName.toLowerCase()}/docker/manual.html`}> How to configure HTTPS with my own certificates in docker </a>
      </li>
      <li>
        <a href={`https://help.passbolt.com/configure/https/${props.productName.toLowerCase()}/docker/auto.html`}> How to configure HTTPS with Let's Encrypt in docker </a>
      </li>
      <li>
