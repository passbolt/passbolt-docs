...
<div>
  <>
    <ul>
      <li>
        <a href={`https://help.passbolt.com/configure/email/setup`}>
          How to configure SMTP to receive emails
        </a>
      </li>
      <li>
        <a
          href={`https://help.passbolt.com/configure/https/${props.productName}/docker/manual.html`}
        >
      ...
      <li>
        <a
          href={`https://help.passbolt.com/configure/https/${props.productName}/docker/auto.html`}
        >
      ...
      <li>
        <a
          href={`https://help.passbolt.com/faq/hosting/how-to-use-rootless-images`}
        >
          How to use rootless images
        </a>
      </li>
      <li>
        <a href={`https://help.passbolt.com/faq/hosting/troubleshoot-docker`}>
          Troubleshoot Docker
        </a>
      </li>
      <li>
        <a
          href={`https://help.passbolt.com/configure/environment/reference.html`}
        >
          Passbolt reference environment variables
        </a>
      </li>
      <li>
        <a href={`https://help.passbolt.com/faq/hosting/docker-secrets`}>
          Docker Secrets
        </a>
      </li>
    </ul>
