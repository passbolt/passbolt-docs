...
<CodeBlock>
  {`wget https://download.passbolt.com/${props.productName.toLowerCase()}/docker/docker-compose-${props.productName.toLowerCase()}.yaml
wget https://github.com/passbolt/passbolt_docker/releases/latest/download/docker-compose-${props.productName.toLowerCase()}-SHA512SUM.txt`}
</CodeBlock>
