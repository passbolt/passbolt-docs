...
<Incrementor title="Download our docker-compose.yml example file" resetCounter={true} />
...
<Incrementor productName={props.productName} title="Configure environment variables in the docker-compose yaml file to customize your instance." />
