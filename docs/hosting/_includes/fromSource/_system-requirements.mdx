...
- PHP >= 8.2.0
- MariaDB >= 10.6 / MySQL >= 8.0 (earlier versions still run, and the healthcheck reports them as deprecated)
...
- [PHP-GNUPG](https://www.php.net/manual/en/gnupg.installation.php): for key verification and authentication.
