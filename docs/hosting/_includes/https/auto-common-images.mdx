...
{props.productName == 'PRO' && (
  <Figure
    size={{ width: '450px', height: 'auto' }}
    src="/img/help/2020/05/debian-package/nginx_choices_pro.png"
...
{props.productName == 'PRO' && (
  <Figure
    size={{ width: '450px', height: 'auto' }}
    src="/img/help/2020/05/debian-package/nginx_domain_pro.png"
...
{props.productName == 'PRO' && (
  <Figure
    size={{ width: '450px', height: 'auto' }}
    src="/img/help/2020/05/debian-package/lets_encrypt_email_pro.png"
