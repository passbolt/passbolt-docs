...
{props.productName == 'PRO' && (
  <Figure
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/ssl_method_select_pro.png"      
...
{props.productName == 'CE' && (
  <Figure 
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/ssl_method_select.png"      
    alt="SSL method selection"
    caption="fig. SSL method selection"
  />
  )}
...
{props.productName == 'PRO' && (
  <Figure
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/ssl_domain_pro.png"      
...
{props.productName == 'CE' && (
  <Figure 
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/ssl_domain.png"      
    alt="Domain for nginx setup"
    caption="fig. Domain for nginx setup"
  />
  )}
...
{props.productName == 'PRO' && (
  <Figure
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/ssl_cert_pro.png"      
...
{props.productName == 'CE' && (
  <Figure 
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/ssl_cert.png"      
    alt="SSL certificate path"
    caption="fig. SSL certificate path"
  />
  )}
...
{props.productName == 'PRO' && (
  <Figure
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/key_ssl_pro.png"      
...
{props.productName == 'CE' && (
  <Figure 
    size={{ width: '450px', height: 'auto' }}
    src="https://help.passbolt.com/assets/img/help/2020/09/debian-package/key_ssl.png"      
    alt="SSL private key path"
    caption="fig. SSL private key path"
  />
  )}
