...
If you have followed our  <a href={`/docs/hosting/install/${props.productName.toLowerCase()}/docker`}>installation documentation</a>, you should have defined `db` and `passbolt` services for your passbolt stack.
