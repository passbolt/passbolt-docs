...
## Requirements
  - <a href={`/hosting/install/${props.productName.toLowerCase()}/docker/`}>docker setup with docker-compose</a>.
  - A domain name reachable over the internet

## Add traefik service to handle https

If you have followed our  <a href={`/hosting/install/${props.productName.toLowerCase()}/docker/`}>installation documentation</a>, you should have defined `db` and `passbolt` services for your passbolt stack.
