...
Prior to the migration you will need to backup the existing passbolt instance data. Please refer to [the official backup documentations](/docs/hosting/backup).
...
extension on a new browser aka, follw the [account recovery](/docs/user/quickstart/browser/setup-on-another-machine) process.
