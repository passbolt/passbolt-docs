...
Prior to the migration you will need to backup the existing passbolt instance data. Please refer to [the official backup documentations](https://help.passbolt.com/hosting/backup).
...
Create a fresh new Passbolt instance on Docker following <a href={`/docs/hosting/install/${props.productName.toLowerCase()}/docker`}>this documentation</a>.
...
If your passbolt URL has changed, you will have to proceed to an [account recovery](https://help.passbolt.com/faq/start/account-recover).
