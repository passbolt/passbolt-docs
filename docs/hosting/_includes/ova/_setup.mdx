...
<div>
  ...
  <ul>
    <li>
      <a href={`/docs/hosting/configure/https/${props.productLabel.toLowerCase()}/debian-auto/`}>Auto (Using Let's Encrypt)</a>
    </li>
    <li>
      <a href={`/docs/hosting/configure/https/${props.productLabel.toLowerCase()}/debian-manual`}>Manual (Using user-provided SSL certificates)</a>
    </li>
  </ul>
</div>
