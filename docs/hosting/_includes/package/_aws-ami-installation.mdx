...
<ul>
  <li>
    <a href={`/docs/hosting/configure/https/${props.productName.toLowerCase()}/aws/auto.html`}> Auto (Using Let's Encrypt) </a>
  </li>
  <li>
    <a href={`/docs/hosting/configure/https/${props.productName.toLowerCase()}/debian/manual.html`}> Manual (Using user-provided SSL certificates)</a>
  </li>
</ul>
