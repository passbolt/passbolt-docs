...
<ul>
  <li>
    <a
      href={`https://help.passbolt.com/configure/https/${props.productName.toLowerCase()}/aws/auto.html`}
    >
  ...
  <li>
    <a
      href={`https://help.passbolt.com/configure/https/${props.productName.toLowerCase()}/debian/manual.html`}
    >
