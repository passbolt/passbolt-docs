...
<>
  ...
  <Figure
    src="https://help.passbolt.com/assets/img/help/2020/12/subscribe-aws-ce.png"
  ...
  <Figure
    src="https://help.passbolt.com/assets/img/help/2020/12/accept-terms-aws-ce.png"
  ...
  <Figure
    src="https://help.passbolt.com/assets/img/help/2020/12/configure-aws-ce.png"
  ...
  <Figure
    src="https://help.passbolt.com/assets/img/help/2021/08/subscribe-aws-pro.png"
    alt="Subscribe to Passbolt Marketplace"
    caption="fig. Subscribe to Passbolt Marketplace"
  />
  <p>
  ...
  <Figure
    src="https://help.passbolt.com/assets/img/help/2021/08/accept-terms-aws-pro.png"
    alt="Accept AMI terms"
    caption="fig. Accept AMI terms"
  />
  <p>
  ...
  <Figure
    src="https://help.passbolt.com/assets/img/help/2021/08/configure-aws-pro.png"
    alt="Configure instance region and version"
    caption="fig. Configure instance region and version"
  />
</>
...
<Figure
  src="https://help.passbolt.com/assets/img/help/2020/12/launch-aws-ce.png"
  alt="Configure instance region and version"
  caption="fig. Configure instance region and version"
/>
) : (
<Figure
  src="https://help.passbolt.com/assets/img/help/2021/08/launch-aws-pro.png"
  alt="Configure instance region and version"
  caption="fig. Configure instance region and version"
/>
)}
...
<ul>
  <li>
    <a href={`https://help.passbolt.com/configure/https/${props.productName.toLowerCase()}/aws/auto.html`}> Auto (Using Let's Encrypt) </a>
  </li>
  <li>
    <a href={`https://help.passbolt.com/configure/https/${props.productName.toLowerCase()}/debian/manual.html`}> Manual (Using user-provided SSL certificates)</a>
  </li>
</ul>
