        ...
        case 'Digital Ocean':
          return (
            <>
              ...
              <ul>
                <li>
                  <Link to={`/docs/hosting/configure/https/ce/digital-ocean-auto/`}>
                    Auto (Using Let's Encrypt)
                  </Link>
                </li>
                <li>
                  <Link to={`/docs/hosting/configure/https/ce/debian-manual/`}>
        ...
        case 'RPM': 
          return (
            <>
              ...
              <ul>
                <li>
                  <Link to={`/docs/hosting/configure/https/${props.productLabel.toLowerCase()}/rpm-auto/`}>
                    Auto (Using Let's Encrypt)
                  </Link>
                </li>
                <li>
                  <Link to={`/docs/hosting/configure/https/${props.productLabel.toLowerCase()}/rpm-manual/`}>
                    Manual (Using user-provided TLS (SSL) certificates)
                  </Link>
                </li>
              </ul>
        ...
        case 'Debian':
          ...
          return (
            <>
              ...
              <ul>
                <li>
                  <Link to={`/docs/hosting/configure/https/pro/ova-auto/`}>
                    Auto (Using Let's Encrypt)
                  </Link>
                </li>
                <li>
                  <Link to={`/docs/hosting/configure/https/pro/debian-manual/`}>
                    Manual (Using user-provided TLS (SSL) certificates)
                  </Link>
                </li>
              </ul>
