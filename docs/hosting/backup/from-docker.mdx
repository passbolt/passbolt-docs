...
If you are running docker container, you should have passed these variables through the command line. Please check the [passbolt env variable reference](https://help.passbolt.com/configure/environment/reference.html)
