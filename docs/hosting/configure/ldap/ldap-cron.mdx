...
To keep your [user directory](/admin/provisioning/users-directory/) in sync automatically, you’ll need to schedule a cron job on your server.  
...
👉 [**Advanced Directory Options**](/admin/provisioning/users-directory/advanced-directory-options/)
