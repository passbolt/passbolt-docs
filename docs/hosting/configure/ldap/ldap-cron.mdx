...
To synchronize the [user directory](/docs/admin/user-provisioning/users-directory) changes automatically you will need to add a cron job on your server. We recommend to execute
