...
:::info Log Management
For log analysis and monitoring, see [Log management](/hosting/maintenance/diagnostics/collect-info/) for log analysis and [Audit log monitoring](/admin/passbolt-api-status/) for audit review.
:::
