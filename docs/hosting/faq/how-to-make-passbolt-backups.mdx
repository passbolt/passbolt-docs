...
However on the server side you can make a regular backup of the entire database. Several methods are available and there is plenty of [documentation available online](http://dev.mysql.com/doc/refman/5.7/en/backup-methods.html).
