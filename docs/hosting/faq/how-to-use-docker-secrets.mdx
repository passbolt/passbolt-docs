...
List of [environment variables](/docs/hosting/configure/https) that can be received as Docker secret and the matching Docker secret path environment variable:
