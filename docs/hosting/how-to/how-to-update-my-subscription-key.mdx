...
<Figure
  src="https://help.passbolt.com/assets/img/screenshots/update-subscription-key-1.jpg"
...
<Figure
  src="https://help.passbolt.com/assets/img/screenshots/update-subscription-key-2.jpg"
...
<Figure
  src="https://help.passbolt.com/assets/img/screenshots/update-subscription-key-3.jpg"
...
To update your subscription key, you need to replace your previous subscription key with the new one. In passbolt, the subscription key is stored in `/var/www/passbolt/config/license` or `/etc/passboly/subscription_key.txt`
