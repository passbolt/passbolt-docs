...
List of [environment variables](/hosting/tls/https/) that can be received as Docker secret and the matching Docker secret path environment variable:
...
### Inject DATASOURCES_DEFAULT_PASSWORD variable using Docker secrets
