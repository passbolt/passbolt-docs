...
We made a dedicated command in order to make a backup of the database, it uses mariadb-dump but we recommend to use the passbolt command as it has been made to avoid any pasting or logins details errors.
