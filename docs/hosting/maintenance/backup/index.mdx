...
- **[From Docker](/hosting/maintenance/backup/from-docker/)** - Backup procedures for Docker deployments
- **[From Packages](/hosting/maintenance/backup/from-packages/)** - Backup procedures for package-based installations
- **[From Sources](/hosting/maintenance/backup/from-sources/)** - Backup procedures for source-based installations
...
- **[From Docker](/hosting/maintenance/backup/from-docker/#how-to-restore-the-database)**
- **[From Packages](/hosting/maintenance/backup/from-packages/#how-to-restore-the-database)**
- **[From Sources](/hosting/maintenance/backup/from-sources/#how-to-restore-the-database)**
