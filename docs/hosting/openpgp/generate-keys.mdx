...
sidebar_label: Generate OpenPGP Key
...
**Organisation Account Recovery**: In this case you want to set a passphrase.
...
9. If you are creating an Organisation Account Recovery key pair set a passphrase, if this is for the server GPG key pair do not set a passphrase
