...
- **Access Control**: Ensuring only authorised users can decrypt shared resources
...
- **Key Distribution**: Sharing metadata keys with authorised users
...
Organisation Recovery Keys (ORK) are used for:
...
- **Organisation Recovery Keys**: Generated with a passphrase (see [Account Recovery](/admin/authentication/account-recovery/) for ORK generation)
...
- [Account Recovery](/admin/authentication/account-recovery/) - Organisation Recovery Key setup
