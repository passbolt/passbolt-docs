...
- **LDAP with TLS**: Directory synchronization uses TLS to secure connections to Active Directory or other LDAP servers, see [LDAP with TLS (SSL) Configuration](/hosting/ldap/ldaps/)
...
- **Before March 15, 2026**: The maximum certificate lifetime is **398 days**.
...
- [HTTPS Configuration](/hosting/tls/https/): Complete HTTPS setup guide
- [Generate a CSR for a CA-signed TLS Certificate](/hosting/tls/generate-csr/): Step-by-step CSR creation with OpenSSL
- [Email Server Configuration](/admin/emails/email-server/): SMTP TLS configuration and certificate trust
- [LDAP with TLS (SSL) Configuration](/hosting/ldap/ldaps/): LDAP TLS configuration and certificate bundling
- [Environment Reference](/hosting/environment-reference/): TLS-related environment variables
- [SSL/TLS Troubleshooting](/hosting/tls/troubleshooting/): Common issues and solutions
