---
title: Troubleshooting TLS (SSL)
description: How to troubleshoot your TLS (SSL) connection
...
You will find infos about how to set up [HTTPS on passbolt here](/hosting/tls/https/)
...
Some companies don't rely on public Certificate Authorities (CA). They generate self-signed certificates and trust them with their own Private Key Infrastructure (PKI).

To trust TLS certificates signed by the PKI, you have to ensure root certificate of your company's PKI has been added in your operating system keychain.
### Chain of trust
...
To manually check if your passbolt TLS certificate has been issued by the correct Certificate Authority (CA), follow the procedure below.
