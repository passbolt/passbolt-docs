...
To setup Duo as multi-factor authentication method, navigate to the multi-factor authentication user settings page: *Avatar > Manage Profile > Multi Factor Authentication*. Select the provider "Duo" to continue.
