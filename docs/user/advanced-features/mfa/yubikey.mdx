...
To setup Yubikey as multi-factor authentication method, navigate to the multi-factor authentication user settings page: *Avatar > Manage Account > Multi Factor Authentication*. Select the provider "Yubikey" to continue.
