...
{/* TODO: capture resource-comments-sidebar.png */}
<Figure
...
On Pro and Cloud, your administrator can remove the right to see comments from a role. The whole section then disappears from the sidebar, which also means the users of that role can no longer comment. In Community Edition the section is always available to whoever has access to the resource.
:::
