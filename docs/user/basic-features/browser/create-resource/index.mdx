...
Pick a colour for the resource icon, or keep **Default color**. Clicking the icon next to the name opens the same form.

#### URIs

The addresses the credential belongs to.
