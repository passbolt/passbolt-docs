...
:::tip[Pro tip]
Since **passbolt >= 5.10** cleartext exports are no longer supported. You are the administrator? You can re-enable the cleartext CSV export following this [FAQ](/hosting/faq/how-to-enable-cleartext-export/)
:::
