...
* [API Authentication](/development/authentication/)
* [Security white paper](pathname:///files/security_white_paper_-_passbolt_pro_edition_v5.10_-_(march_2026_-_rev10).pdf)
