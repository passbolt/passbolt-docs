---
title: Setup the Account recovery
description: How to subscrive to the account recovery program
slug: setup-account-recovery
---
...
in case of recovery kit or passphrase loss. To know more about account recovery, checkout this [documentation](/docs/admin/authentication/account-recovery/).
...
<Figure
  src="/img/help/2022/07/account-recovery-during-setup.png"
...
<Figure
  src="/img/help/2022/07/account-recovery-setting.png"
