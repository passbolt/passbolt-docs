---
title: Passbolt Account Recovery via Administrator
...
material is encrypted using an organisation recovery key.
...
- Account recovery was setup for your organisation by your administrator.
- You are in possession of a valid user account (you have completed the setup, and you are not suspended);
- You subscribed to the account recovery program while installing passbolt for the first time or via in your [user settings workspace](/user/settings/browser/account-recovery-setup/).
...
- [Account recovery in Administrator Guide](/admin/authentication/account-recovery/)
