...
- You subscribed to the account recovery program while installing passbolt for the first time or via in your [user settings workspace](/docs/user/settings/browser/account-recovery-setup).
