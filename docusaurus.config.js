    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { from: '/admin/metadata-encryption/', to: '/admin/resource-types/' },
          { from: '/admin/password-configuration/', to: '/admin/resource-policies/' },
          { from: '/admin/server-maintenance/', to: '/admin/passbolt-api-status/' },
        ],
      },
    ],
  ],
