    ...
    <div className={styles.root} {...props}>
      ...
      {links && (
        <div className={styles.links}>
          {links.ce && (
            <Badge className={clsx([styles.link, styles.linkCe])} href={links.ce}>CE</Badge>
          )}
          {links.pro && (
            <Badge className={clsx([styles.link, styles.linkPro])} href={links.pro} variant='secondary'>Pro</Badge>
          )}
        </div>
      )}
    </div>
